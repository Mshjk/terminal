...
namespace winrt::TerminalApp::implementation
{
    ...
    void CommandPalette::OnTabsChanged(const IInspectable& s, const IVectorChangedEventArgs& e)
    {
        if (auto tabList = s.try_as<IObservableVector<TerminalApp::Tab>>())
        {
            ...
            {
                // TODO CARLOS: Begin my approach
                //auto item{ _allTabActions.GetAt(idx) };
                //item.PropertyChanged(winrt::auto_revoke);
                // TODO CARLOS: We can't get_self. Not allowed anymore.
